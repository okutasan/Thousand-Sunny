  ...
  <div class="header-image">
    ...
    <div class="row">
            <div class="column left">
                <div class="map">
                        <h3>Materi Kursus Dasar Mikrotik</h3>
                        <div class="vertical-menu">
                        <a href="mikrotik1.html">Apa itu Mikrotik ?</a>
                        <a href="mikrotik2.html">Instalasi Mikrotik</a>
                        <a href="mikrotik3.html">Remote Mikrotik</a>
            ...
            <div class="column right">
              <div class="post">
              <h2 style="margin:17px 10px 10px 10px; text-align:center;">HASIL QUIZ Mikrotik</h2>
              <!-- PHP Grade -->
                <?php
